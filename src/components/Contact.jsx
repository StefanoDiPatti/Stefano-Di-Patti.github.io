...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_r9kxz5q', 'template_8hue4ws',
    {from_name: form.name, to_name: 'Stefano', from_email: form.email, to_email: 'stefano.dipatti97@gmail.com', message: form.message}, 'FV2KTyj_BMnUIXLbn').then(()=>{
      setLoading(false)
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={slideIn('up', "tween", 0.2, 1)} className="w-full flex-[0-75] bg-black-100 p-8 rounded-2xl">
